"""
LeetCode#238
Given an integer array, nums, return an array, products, such that product[i] 
...
class Solution:
    def productExceptSelf(self, nums: List[int]) -> List[int]:
        """
        Finds the product of all elements except self in a given integer array.
        Args:
            nums: The input list of integers.
        Returns:
            A list of integers where the i-th element is the product of all the elements of nums except nums[i].
        """
